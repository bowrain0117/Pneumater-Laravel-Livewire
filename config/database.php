    ...
    */
    ...
    'connections' => [
        ...
        'istat' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ISTAT_HOST', '127.0.0.1'),
            'port' => env('DB_ISTAT_PORT', '3306'),
            'database' => env('DB_ISTAT_DATABASE', 'forge'),
            'username' => env('DB_ISTAT_USERNAME', 'forge'),
            'password' => env('DB_ISTAT_PASSWORD', ''),
            'unix_socket' => env('DB_ISTAT_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,

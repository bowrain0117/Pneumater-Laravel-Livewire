<x-app-layout>
    ...
    <div class="mt-4">
        <div class="flex flex-wrap -mx-6">
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mt-1">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\Tire::where("status",App\Enums\TireStatus::Available)->count() }}</h4>
                        <div class="text-gray-500">Pneumatici disponibili</div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mt-1">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\Reservation::count() }}</h4>
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mt-1">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\Shipment::where("status","!=",\App\Enums\ShipmentStatus::Processed)->count() }}</h4>
                        <div class="text-gray-500">Spedizioni</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mt-4">
        <h3 class="text-gray-700 text-2xl font-medium">Pneumatici per categoria</h3>
        <div class="flex flex-wrap -mx-6">
            @foreach(\App\Enums\TireCategory::getValues() as $category)
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mt-1">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\Tire::where('category', $category)->where('status',\App\Enums\TireStatus::Available)->count() }}</h4>
                            <div class="text-gray-500">{{ \App\Enums\TireCategory::getDescription($category) }} (disponibili)</div>
                        </div>
                    </div>
                </div>
            @endforeach
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mt-1">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\Tire::where('category', $category)->where('status',\App\Enums\TireStatus::Reserved)->count() }}</h4>
                        <div class="text-gray-500">Pneumatici prenotati</div>
                    </div>
                </div>
            </div>
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mt-1">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\Tire::where('category', $category)->where('status',\App\Enums\TireStatus::ToShip)->count() }}</h4>
                        <div class="text-gray-500">Pneumatici in spedizione</div>
                    </div>
                </div>
            </div>
        </div>

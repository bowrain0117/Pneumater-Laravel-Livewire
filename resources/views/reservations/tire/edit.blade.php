<x-app-layout>
    <h3 class="text-gray-700 text-3xl font-medium">Prenotazione - Modifica pneumatico</h3>

    <form action="{{ route('reservations.tire.update',['reservation' => $reservation, 'tire' => $tire]) }}" method="POST">

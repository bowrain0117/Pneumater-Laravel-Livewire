<x-app-layout>
    ...
    <form action="{{ route('shipments.update', ['shipment' => $shipment ]) }}" method="POST">
        <input name="_method" type="hidden" value="PUT">
        <input type="hidden" name="id" value="{{ $shipment->id }}">
        @csrf

        <livewire:shipment.form :shipment="$shipment"/>
    </form>
    <div class="mt-4">
        <div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="relative px-6 py-3 text-right">
                                        <a href="{{ route('shipments.tire.create', ['shipment' => $shipment]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            @if(!auth()->user()->lock_price_edit)
                                                <a href="{{ route('shipments.tire.edit', ['shipment' => $shipment, 'tire' => $tire]) }}">
                                                    <button
                                                ...
                                                <div x-show="showModal"
                                                    ...
                                                    <div x-show="showModal"
                                                        ...
                                                        <div class="text-right space-x-5 mt-5">
                                                            <form
                                                                action="{{ route('shipments.tire.destroy', ['shipment' => $shipment, 'tire' => $tire]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                        ...
                        <div class="bg-white">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="relative px-6 py-3 text-right">
                                        <a href="{{ action('\App\Http\Controllers\ProductController@create',['shipment' => $shipment->id]) }}"
                                           class="text-indigo-600 hover:text-indigo-900">Aggiungi</a>
                                    </th>
                                </tr>
                                </thead>
